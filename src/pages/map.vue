<template>
  <div class="main_container">
    <header>
      <h1>金牛区智慧厕所引导系统</h1>
      <el-button class="data-btn" @click="toData">前往数据主页</el-button>
      <ul class="nowWeather">
    ...
    <div class="mainbox">
      <div class="column">
        ...
        <div class="panel">
          <div class="module_title">近一周客流分析</div>
          <div
            id="weekly_chart"
            style="width: 90%; height: 23vh; margin: 0 auto"
          ></div>
          <div class="panel_footer"></div>
        </div>
        <div class="panel">
          <div class="module_title">用水状态 / 用电状态</div>
          <div
            id="flow_chart"
            style="width: 90%; height: 23vh; margin: 0 auto"
          ></div>
        ...
        <div class="panel">
          <div class="module_title">本月用水量 / 用电量</div>
          <div class="water_electronic">
            <div class="waterCircle">
              <div class="waterData">暂无数据</div>
              <div class="circle_line"></div>
              <div class="waterDetail">用 水 量</div>
            </div>
            <div class="electronicCircle">
              <div class="electronicData">暂无数据</div>
              <div class="electronic_line"></div>
              <div class="electronicDetail">用 电 量</div>
            </div>
          </div>
          <div class="panel_footer"></div>
        </div>
      ...
      <div class="column">
        <!-- <div class="column_top wc_title">
          <div class="gradient-box">警报！xxx公厕有人呼救！</div>
        </div> -->
        <div class="flow_display">
          <div class="flow_box">
            <div class="panel flow_panel">
              <div class="module_title">男厕日客流量</div>
              <div class="flow_body">
                <div class="flow_left">{{ man_today_crowd }}</div>
                <div class="flow_right">人次</div>
              </div>
              <div class="panel_footer"></div>
            </div>
          </div>
          <div class="flow_box">
            <div class="panel flow_panel">
              <div class="module_title">男厕总客流量</div>
              <div class="flow_body">
                <div class="flow_left">{{ man_total_crowd }}</div>
                <div class="flow_right">人次</div>
              </div>
              <div class="panel_footer"></div>
            </div>
          ...
          <div class="flow_box">
            <div class="panel flow_panel">
              <div class="module_title">女厕日客流量</div>
              <div class="flow_body">
                <div class="flow_left">{{ woman_today_crowd }}</div>
                <div class="flow_right">人次</div>
              </div>
              <div class="panel_footer"></div>
            </div>
          ...
          <div class="flow_box">
            <div class="panel flow_panel">
              <div class="module_title">女厕总客流量</div>
              <div class="flow_body">
                <div class="flow_left">{{ woman_total_crowd }}</div>
                <div class="flow_right">人次</div>
              </div>
              <div class="panel_footer"></div>
            </div>
          ...
          <div class="mapDiv">
            ...
            >
              ...
              <tdt-marker
                ...
                @click="toiletScreen(marker.title)"
              >
              </tdt-marker>
              <tdt-infowindow
              ...
              <!-- <div
                ...
                :key="index"
                v-if="tooltip.show && tooltipIndex === index"
                class="tooltip"
              >
                {{ tooltip.content }}
              </div> -->
        ...
        <!-- <el-dialog v-model="toilet_1_visible" title="xxx公厕今日数据">
          <ToiletsData style="width: 100%" />
        </el-dialog>
        <el-dialog v-model="toilet_2_visible" title="xxx公厕今日数据">
          <ToiletsData style="width: 100%" />
        </el-dialog>
        <el-dialog v-model="toilet_3_visible" title="xxx公厕今日数据">
          <ToiletsData style="width: 100%" />
        </el-dialog> -->
      </div>
      <div class="column">
        <div class="column_top"></div>
        <div class="panel">
          <div class="module_title">警 报 栏</div>
          <el-table
            :data="tableData"
            style="
              width: 100%;
        ...
        <div class="panel">
          <div class="module_title">用 纸 量</div>
          <div
            id="paper_chart"
            style="width: 90%; height: 23vh; margin: 0 auto"
          ></div>
        ...
        <div class="panel">
          <div class="module_title">服 务 评 价</div>
          <div class="emotion_box">
            <div class="emotion">
              <div class="emotion_happy">
                <span class="iconfont emotion_icon">&#xe7a9;</span>
              </div>
              <div class="emotion_percent">{{level_nice}}%</div>
            </div>
            <div class="emotion">
              <div class="emotion_happy">
                <span class="iconfont emotion_icon">&#xe635;</span>
              </div>
              <div class="emotion_percent">{{level_normal}}%</div>
            </div>
            <div class="emotion">
              <div class="emotion_happy">
                <span class="iconfont emotion_icon">&#xe634;</span>
              </div>
              <div class="emotion_percent">{{level_bad}}%</div>
            </div>
          </div>
          <div class="panel_footer"></div>
        </div>
...
const loadAll = () => {
  return [
    ...
    { value: "【金牛区面街】轻松驿站•智慧厕所", position: "[104.04433, 30.69937]" },
  { value: "【金牛区西青路】轻松驿站•智慧厕所", position: "[104.045593, 30.671122]"},
  { value: "【金牛凯德广场】轻松驿站•智慧厕所", position: "[104.040695, 30.706947]" },
  { value: "【金牛公园】轻松驿站•智慧厕所", position: "[104.022646, 30.703025]" },
  { value: "【金牛花圃北路】轻松驿站•智慧厕所", position: "[104.07589, 30.683405]" },
  ]
}

const handleSelect = (item: RestaurantItem) => {
  console.log(item.value)
  if (item.value === '【金牛区面街】轻松驿站•智慧厕所' || item.value === '【金牛区西青路】轻松驿站•智慧厕所'|| item.value === '【金牛凯德广场】轻松驿站•智慧厕所' || item.value === '【金牛公园】轻松驿站•智慧厕所' || item.value === '【金牛花圃北路】轻松驿站•智慧厕所') {
    router.push({ path: "/mobileTvMap", query: { param: item.value } });
  } else {
    router.push({ path: "/tvMap", query: { param: item.value } });
  }
  ...
  axios({
    ...
    for (var sensor in res) {
      var currentCar = {
        ...
        detail:
          res[sensor].time +res[sensor].toilet_name +
          " " +
          res[sensor].gender +
          " " +
          res[sensor].status,
...
function fetchData() {
  axios({
    url: "/api/crowd/allCrowdTotal",
   
    method: "get",
  }).then(function (resp) {
    if (resp.status == 200) {
      woman_today_crowd.value = resp.data.today_woman_flow;
      man_today_crowd.value = resp.data.today_man_flow;
      disan_today_crowd.value = resp.data.today_other_flow;
    }
  });
...
onBeforeUnmount(() => {
  if (flowChart) {
    window.removeEventListener("resize", flowChart);
    flowChart.dispose();
    flowChart = null;
  }
  if (personChart) {
    window.removeEventListener("resize", personChart);
    personChart.dispose();
    personChart = null;
  }
  if (paperChart) {
    window.removeEventListener("resize", paperChart);
    paperChart.dispose();
    paperChart = null;
  }
});

function showPaperChart() {
  var chartDom = document.getElementById("paper_chart");
  paperChart = echarts.init(chartDom);
  var option;
  option = {
    legend: {
      textStyle: {
  ...
  option && paperChart.setOption(option);
}
...
function showPersonChart() {
  ...
  // axios({
  //   url: "/api/daily-occupancy/hourOfTodayFlow",
  //   data: {
  //     toilet_location: "枣子巷",
  //   },
  //   method: "post",
  ...
  //     },
  //     legend: {
  //       data: [...new Set(dataTable.map((item) => item.gender))],
  //       textStyle: {
  //         color: "#4c9bfd", // 更改标题颜色
  //         fontSize: "0.2rem",
  //       },
  ...
  //               {
  //                 offset: 0,
  //                 color: "rgba(255,105,180,0.4)", // 渐变色的起始颜色
  //               },
  //               {
  //                 offset: 0.8,
  //                 color: "rgba(255,105,180,0.1)", // 渐变线的结束颜色
  //               },
  //             ],
  //             false
  //           ),
  ...
  //   option && personChart.setOption(option);
  // });
}
...
function showFlowChart() {
  //渲染完之后再拿dom元素
  var chartDom = document.getElementById("flow_chart");
...
function toiletScreen(location) {
...
// const toilet_2_visible = ref(false);
// const toilet_3_visible = ref(false);
//地图在页面中的视野大小以及位置
const state = reactive({
  //中心点的经纬度,第一个是经度,第二个是维度
  center: [104.04740358713781, 30.72735604287413],
...
const markers = [
  ...
  { title: "【金牛区面街】轻松驿站•智慧厕所", position: [104.04433, 30.69937] },
  { title: "【金牛区西青路】轻松驿站•智慧厕所", position: [104.045593, 30.671122] },
  { title: "【金牛凯德广场】轻松驿站•智慧厕所", position: [104.040695, 30.706947] },
  { title: "【金牛公园】轻松驿站•智慧厕所", position: [104.022646, 30.703025] },
  { title: "【金牛花圃北路】轻松驿站•智慧厕所", position: [104.07589, 30.683405] },
];
...
.waterCircle {
  ...
  border: 0.1rem solid #34dba3;
  border-radius: 50%; /* 将border-radius设置为50%以创建圆形 */
}
.circle_line {
  border: 0.01rem solid #34dba3;
  width: 10vh;
  margin: 0 auto;
}
.waterCircle .waterData,
.waterDetail {
  height: 50%;
  text-align: center;
  padding-top: 3vh;
...
.waterCircle .waterDetail {
  padding-top: 0.7vh;
}
.electronic_line {
  border: 0.01rem solid #3498db;
  width: 10vh;
  margin: 0 auto;
}
...
.electronicCircle .electronicData,
.electronicDetail {
  height: 50%;
  text-align: center;
  padding-top: 3vh;
...
.electronicCircle .electronicDetail {
  padding-top: 0.7vh;
}
.iconfont {
...
.main_container {
  ...
  background-position: 10 center; /* 居中对齐背景图片 */

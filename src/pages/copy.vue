        ...
        <div class="flow_display">
          <div class="flow_box">
            <div class="panel flow_panel">
              <div class="flow_title">男厕日客流量</div>
              <div class="flow_body">
                <div class="flow_left">145</div>
          ...
          <div class="flow_box">
            <div class="panel flow_panel">
              <div class="flow_title">男厕总客流量</div>
              <div class="flow_body">
                <div class="flow_left">91154</div>
                <div class="flow_right">人次</div>
              </div>
              <div class="panel_footer"></div>
            </div>
          ...
          <div class="flow_box">
            <div class="panel flow_panel">
              <div class="flow_title">女厕日客流量</div>
              <div class="flow_body">
                <div class="flow_left">215</div>
                <div class="flow_right">人次</div>
              </div>
              <div class="panel_footer"></div>
            </div>
          ...
          <div class="mapDiv">
            ...
            >
              ...
              <tdt-marker
                ...
                @click="toilet_1_visible = true"
                :icon="toilet_one.icon"
              >
              </tdt-marker>
              <tdt-marker
                :position="toilet_two.position"
                @click="toilet_2_visible = true"
                :icon="toilet_two.icon"
              >
              </tdt-marker>
              <tdt-marker
                :position="toilet_three.position"
                @click="toilet_3_visible = true"
                :icon="toilet_three.icon"
              ></tdt-marker>
            </tdt-map>
          </div>
        </div>
...
import iconUrl from "~/assets/images/icon_marker.jpg";
...
const toilet_three = reactive({
  position: [104.045243, 30.690125],
  visible: true,
  icon: {
    iconUrl: iconUrl,
    iconSize: [25, 40],
